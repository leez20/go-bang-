...
int bajudyy1(struct chess black);//judge ????b
int bajudyy2(struct chess black);//judge b????
...
int bajudul1(struct chess black);//judge ????b
int bajudul2(struct chess black);//judge b????
