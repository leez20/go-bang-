...
bful4=0,bful3=0,bful2=0,bful1=0,bhal4=0,bhal3=0,bhal2=0;//initialize
int max=0;
...
if(max2>=max1)
{
	...
	case 8:
		switch (max1)
		{
			case 8:
				for(i=0;i<wful4;i++)
					for(j=0;j<bful4;j++)
					if(wfull4[i].x==bfull4[j].x && wfull4[i].y==bfull4[j].y)
						{
						signal=1;
						random=i;
						break;
				...
				if(signal!=1)
				  random=random%wful4;
			break;
			default:random=random%wful4;
			break;
		}	
		board[wfull4[random].y][wfull4[random].x]=13;
		board[wchess[wnum-1].y][wchess[wnum-1].x]=12;
		wchess[wnum++]=wfull4[random];
		break;
	case 7:
		random=random%whal4;
		board[whalf4[random].y][whalf4[random].x]=13;
		board[wchess[wnum-1].y][wchess[wnum-1].x]=12;
		wchess[wnum++]=whalf4[random];
		break;
	case 6:
		random=random%wful3;
	...
	case 8:
		random=random%bful4;
		board[bfull4[random].y][bfull4[random].x]=13;
		board[wchess[wnum-1].y][wchess[wnum-1].x]=12;
		wchess[wnum++]=bfull4[random];
		break;
	case 7:
		random=random%bhal4;
		board[bhalf4[random].y][bhalf4[random].x]=13;
		board[wchess[wnum-1].y][wchess[wnum-1].x]=12;
		wchess[wnum++]=bhalf4[random];
		break;
	case 6:
		random=random%bful3;
