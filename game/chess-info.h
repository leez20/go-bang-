...
//black yy line single side judge
...
//black up left line single side judge
...
//black up right line single side judge

int bajudur1(struct chess black){
int x0=black.x,y0=black.y;
int A,B,C,D,E;
int b=y0+x0,Y,X;
int i; ////func y=-x+b  b=y0x0
for(i=1;i<6;i++)
{
X=x0-i;
Y=(-1)*X+b;
...
//white chess line single side info
...
int wajudul1(struct chess white){
...
int wajudur1(struct chess white){
int x0=white.x,y0=white.y;
int A,B,C,D;
int b=y0+x0,Y,X;
int i; ////func y=-x+b  b=y0x0
...
int wajudur2(struct chess white){
int x0=white.x,y0=white.y;
int A,B,C,D;
int b=y0+x0,Y,X;
int i; ////func y=-x+b  b=y0x0
